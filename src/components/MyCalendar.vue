...
export default {
  ...
  methods: {
    ...
    // Change the view to day mode for the selected date
    viewDay({ date }) {
      this.focus = date;
      this.type = 'day';
    },
    ...
    // Set the focus date to today
    setToday() {
      this.focus = '';
    },

    // Go to the previous time period
    prev() {
    ...
    // Enable editing mode for an event
    editEvent(ev) {
    ...
    // Update the range of events shown on the calendar
